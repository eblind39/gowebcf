...
func FnTemplateHTMLFns(w http.ResponseWriter, r *http.Request) {
	funciones := template.FuncMap{
		"hola": hola,
		"suma": suma,
	}

	template, err := template.New("funciones.html").Funcs(funciones).ParseFiles("templates/funciones.html")
	if err != nil {
		panic(err)
	}
...
func main() {
	http.HandleFunc("/", FnTemplateHTMLFns)
